...
use crate::{Player, MINIMAL_PLAYER_Y};
    ...
    fn build(&self, app: &mut App) {
        app.add_event::<MovementAction>()
            ...
            .add_systems(
                ...
                kinematic_controller_collisions.run_if(in_state(Screen::Playing)),
            )
            .add_systems(Update, player_respawn.run_if(in_state(Screen::Playing)));
    }
}
